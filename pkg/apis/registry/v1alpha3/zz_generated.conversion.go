...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*HTTP)(nil), (*registry.HTTP)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha3_HTTP_To_registry_HTTP(a.(*HTTP), b.(*registry.HTTP), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*registry.HTTP)(nil), (*HTTP)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_registry_HTTP_To_v1alpha3_HTTP(a.(*registry.HTTP), b.(*HTTP), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*HighAvailability)(nil), (*registry.HighAvailability)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha3_HighAvailability_To_registry_HighAvailability(a.(*HighAvailability), b.(*registry.HighAvailability), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*registry.HighAvailability)(nil), (*HighAvailability)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_registry_HighAvailability_To_v1alpha3_HighAvailability(a.(*registry.HighAvailability), b.(*HighAvailability), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*Proxy)(nil), (*registry.Proxy)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha3_Proxy_To_registry_Proxy(a.(*Proxy), b.(*registry.Proxy), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*registry.Proxy)(nil), (*Proxy)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_registry_Proxy_To_v1alpha3_Proxy(a.(*registry.Proxy), b.(*Proxy), scope)
	}); err != nil {
		return err
	}
...
// Convert_v1alpha3_HTTP_To_registry_HTTP is an autogenerated conversion function.
func Convert_v1alpha3_HTTP_To_registry_HTTP(in *HTTP, out *registry.HTTP, s conversion.Scope) error {
	return autoConvert_v1alpha3_HTTP_To_registry_HTTP(in, out, s)
}
...
// Convert_registry_HTTP_To_v1alpha3_HTTP is an autogenerated conversion function.
func Convert_registry_HTTP_To_v1alpha3_HTTP(in *registry.HTTP, out *HTTP, s conversion.Scope) error {
	return autoConvert_registry_HTTP_To_v1alpha3_HTTP(in, out, s)
}
...
// Convert_v1alpha3_HighAvailability_To_registry_HighAvailability is an autogenerated conversion function.
func Convert_v1alpha3_HighAvailability_To_registry_HighAvailability(in *HighAvailability, out *registry.HighAvailability, s conversion.Scope) error {
	return autoConvert_v1alpha3_HighAvailability_To_registry_HighAvailability(in, out, s)
}
...
// Convert_registry_HighAvailability_To_v1alpha3_HighAvailability is an autogenerated conversion function.
func Convert_registry_HighAvailability_To_v1alpha3_HighAvailability(in *registry.HighAvailability, out *HighAvailability, s conversion.Scope) error {
	return autoConvert_registry_HighAvailability_To_v1alpha3_HighAvailability(in, out, s)
}
...
// Convert_v1alpha3_Proxy_To_registry_Proxy is an autogenerated conversion function.
func Convert_v1alpha3_Proxy_To_registry_Proxy(in *Proxy, out *registry.Proxy, s conversion.Scope) error {
	return autoConvert_v1alpha3_Proxy_To_registry_Proxy(in, out, s)
}
...
// Convert_registry_Proxy_To_v1alpha3_Proxy is an autogenerated conversion function.
func Convert_registry_Proxy_To_v1alpha3_Proxy(in *registry.Proxy, out *Proxy, s conversion.Scope) error {
	return autoConvert_registry_Proxy_To_v1alpha3_Proxy(in, out, s)
}
...
func autoConvert_v1alpha3_RegistryStatus_To_registry_RegistryStatus(in *RegistryStatus, out *registry.RegistryStatus, s conversion.Scope) error {
	out.CASecretName = (*string)(unsafe.Pointer(in.CASecretName))
